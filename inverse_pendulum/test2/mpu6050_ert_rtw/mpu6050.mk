###########################################################################
## Makefile generated for Simulink model 'mpu6050'. 
## 
## Makefile     : mpu6050.mk
## Generated on : Sun Dec 25 08:12:16 2016
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mpu6050.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/shohei/Documents/MATLAB/Projects/control/inverse_pendulum/test2
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = mpu6050_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mpu6050.elf
...
DEFINES_STANDARD = -DMODEL=mpu6050 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
%.o : $(START_DIR)/mpu6050_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/mpu6050_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/mpu6050_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
