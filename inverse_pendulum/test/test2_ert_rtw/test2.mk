###########################################################################
## Makefile generated for Simulink model 'test2'. 
## 
## Makefile     : test2.mk
## Generated on : Wed Dec 21 14:48:58 2016
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/test2.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/shohei/Documents/MATLAB/Projects/control/inverse_pendulum/test
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = test2_ref.rsp
...
# Toolchain Name:          Arduino AVR v1.6.1 | gmake (64-bit Mac)
# Supported Version(s):    
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/test2.elf
...
INCLUDES_BUILDINFO = -I/Users/shohei/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinobase/include -I/Users/shohei/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinobase/blocks/sfcn/include -I$(START_DIR)/test2_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/standard -I$(ARDUINO_ROOT)/libraries/Servo/src -I/Users/shohei/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinotarget/registry/../include -I/Users/shohei/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/include
...
DEFINES_ = -DMODEL=test2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX -DON_TARGET_WAIT_FOR_START=1 -DONESTEPFCN=1 -DEXT_MODE=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -DMW_TIMERID=2 -DMW_PRESCALAR=1024 -DMW_TIMERCOUNT=6 -DMW_SCHEDULERCOUNTER=125 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=test2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/test2_ert_rtw/rtGetInf.c $(START_DIR)/test2_ert_rtw/rtGetNaN.c $(START_DIR)/test2_ert_rtw/rt_nonfinite.c $(START_DIR)/test2_ert_rtw/test2.c $(START_DIR)/test2_ert_rtw/test2_data.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(START_DIR)/motorDriver_wrapper.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/hooks.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/WInterrupts.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_analog.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_digital.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_pulse.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/wiring_shift.c $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/abi.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/CDC.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial0.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial1.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial2.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HardwareSerial3.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/HID.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/IPAddress.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/new.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/Print.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/Stream.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/Tone.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/USBCore.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/WMath.cpp $(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino/WString.cpp /Users/shohei/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp /Users/shohei/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp /Users/shohei/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp $(MATLAB_ROOT)/rtw/c/src/ext_mode/serial/ext_serial_pkt.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/serial/rtiostream_serial_interface.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/serial/ext_svr_serial_transport.c /Users/shohei/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinotarget/registry/../src/rtiostream_serial.cpp

MAIN_SRC = $(START_DIR)/test2_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/test2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/test2_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/test2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_ArduinoHWInit.o : /Users/shohei/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


io_wrappers.o : /Users/shohei/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


arduinoAVRScheduler.o : /Users/shohei/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rtiostream_serial.o : /Users/shohei/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinotarget/registry/../src/rtiostream_serial.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
