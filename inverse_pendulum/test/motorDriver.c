 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Wed Dec 21 15:58:21 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME motorDriver
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          4
/* Input Port  0 */
#define IN_PORT_0_NAME      speed1
...
/* Input Port  2 */
#define IN_PORT_2_NAME      direction1
...
/* Input Port  3 */
#define IN_PORT_3_NAME      direction2
#define INPUT_3_WIDTH       1
#define INPUT_DIMS_3_COL    1
#define INPUT_3_DTYPE       int8_T
...
{
    const int8_T   *speed1  = (const int8_T*) ssGetInputPortSignal(S,0);
    const int8_T   *speed2  = (const int8_T*) ssGetInputPortSignal(S,1);
    const int8_T   *direction1  = (const int8_T*) ssGetInputPortSignal(S,2);
    const int8_T   *direction2  = (const int8_T*) ssGetInputPortSignal(S,3);
    const real_T   *xD = ssGetDiscStates(S);

    motorDriver_Outputs_wrapper(speed1, speed2, direction1, direction2, xD);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    motorDriver_Update_wrapper(speed1, speed2, direction1, direction2,  xD);
}
