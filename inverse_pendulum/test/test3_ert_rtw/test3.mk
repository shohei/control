###########################################################################
## Makefile generated for Simulink model 'test3'. 
## 
## Makefile     : test3.mk
## Generated on : Wed Dec 21 15:28:12 2016
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/test3.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = test3_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/test3.elf
...
DEFINES_ = -DMODEL=test3 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -DMW_TIMERID=1 -DMW_PRESCALAR=1024 -DMW_TIMERCOUNT=34286 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=test3 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
%.o : $(START_DIR)/test3_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/test3_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/test3_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
