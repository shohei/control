###########################################################################
## Makefile generated for Simulink model 'mpu6050test'. 
## 
## Makefile     : mpu6050test.mk
## Generated on : Wed Dec 21 16:35:50 2016
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mpu6050test.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = mpu6050test_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mpu6050test.elf
...
DEFINES_STANDARD = -DMODEL=mpu6050test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
%.o : $(START_DIR)/mpu6050test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/mpu6050test_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/mpu6050test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
