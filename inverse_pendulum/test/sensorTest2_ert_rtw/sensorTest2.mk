###########################################################################
## Makefile generated for Simulink model 'sensorTest2'. 
## 
## Makefile     : sensorTest2.mk
## Generated on : Sat Dec 24 16:45:52 2016
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/sensorTest2.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = sensorTest2_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/sensorTest2.elf
...
DEFINES_STANDARD = -DMODEL=sensorTest2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
%.o : $(START_DIR)/sensorTest2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/sensorTest2_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/sensorTest2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
