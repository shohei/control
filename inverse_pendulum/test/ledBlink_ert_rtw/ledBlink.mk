###########################################################################
## Makefile generated for Simulink model 'ledBlink'. 
## 
## Makefile     : ledBlink.mk
## Generated on : Wed Dec 21 14:24:56 2016
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ledBlink.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = ledBlink_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ledBlink.elf
...
INCLUDES_BUILDINFO = -I/Users/shohei/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinobase/include -I/Users/shohei/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinobase/blocks/sfcn/include -I$(START_DIR)/ledBlink_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/standard -I$(ARDUINO_ROOT)/libraries/Servo/src -I/Users/shohei/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinotarget/registry/../include -I/Users/shohei/Documents/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/include
...
DEFINES_ = -DMODEL=ledBlink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -DMW_TIMERID=1 -DMW_PRESCALAR=1024 -DMW_TIMERCOUNT=49911 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=ledBlink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
%.o : $(START_DIR)/ledBlink_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ledBlink_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/ledBlink_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
