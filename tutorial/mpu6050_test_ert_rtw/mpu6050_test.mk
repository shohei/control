###########################################################################
## Makefile generated for Simulink model 'mpu6050_test'. 
## 
## Makefile     : mpu6050_test.mk
## Generated on : Sun Dec 25 10:22:54 2016
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mpu6050_test.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = mpu6050_test_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mpu6050_test.elf
...
DEFINES_STANDARD = -DMODEL=mpu6050_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
%.o : $(START_DIR)/mpu6050_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/mpu6050_test_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/mpu6050_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
