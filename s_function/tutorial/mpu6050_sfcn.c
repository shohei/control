 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sun Dec 25 08:23:57 2016
*/
...
{
    real_T        *roll  = (real_T *)ssGetOutputPortRealSignal(S,0);
    ...
    mpu6050_sfcn_Outputs_wrapper(roll, pitch, yaw, xD);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    mpu6050_sfcn_Update_wrapper(roll, pitch, yaw,  xD);
}
