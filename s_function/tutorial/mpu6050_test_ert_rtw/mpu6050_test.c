...
void mpu6050_test_initialize(void)
{
  ...
  /* External mode info */
  mpu6050_test_M->Sizes.checksums[0] = (3905585814U);
  mpu6050_test_M->Sizes.checksums[1] = (1496018846U);
  mpu6050_test_M->Sizes.checksums[2] = (406281864U);
  mpu6050_test_M->Sizes.checksums[3] = (295099700U);
