 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Mon Dec 19 18:22:10 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME led
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          1
/* Input Port  0 */
#define IN_PORT_0_NAME      ledPin
...
{
    const int8_T   *ledPin  = (const int8_T*) ssGetInputPortSignal(S,0);
    const real_T   *xD = ssGetDiscStates(S);

    led_Outputs_wrapper(ledPin, xD);
